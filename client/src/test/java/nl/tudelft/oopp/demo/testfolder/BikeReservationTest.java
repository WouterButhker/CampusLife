...
class BikeReservationTest {
    ...
    void init() {
        ...
        dropOffBuilding = new Building(2, "Test2", "Test street2",
                "06:00-18:00, 06:00-18:00, 06:00-18:00, "
                        +  "06:00-18:00, 06:00-18:00, 06:00-18:00, 19:00-21:00", 32);
        date = "22/03/2020";
    ...
    void setPickUpBuildingTest() {
        Building test = new Building(3, "Changed", "Test street",
                "06:00-18:00, 06:00-18:00, 06:00-18:00, "
                        + "06:00-18:00, 06:00-18:00, 06:00-18:00, 19:00-21:00", 45);
    ...
    void equalsDifferentObjectsSameBikeReservationTest() {
        BikeReservation test = new BikeReservation(id, user,
                pickUpBuilding, dropOffBuilding, date, timeSlot);
